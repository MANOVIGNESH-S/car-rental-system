...
import { CalendarDays, CreditCard, Car, ChevronRight, ArrowLeft } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        {/* BACK BUTTON */}
        <div className="mb-4">
          <Link to="/portal" className="inline-flex items-center gap-2 text-sm text-gray-500 hover:text-blue-600 transition-colors">
